...
func newTestManager(isDev bool) *Manager {
	return NewManager(ManagerConfig{
		KeysetFunc: createTestKeyset,
		IsDevFunc:  func() bool { return isDev },
	})
}
...
func TestNewManager(t *testing.T) {
	t.Run("panics with nil KeysetFunc", func(t *testing.T) {
		defer func() {
			if r := recover(); r == nil {
				t.Errorf("expected panic with nil KeysetFunc")
			}
		}()
