...
var nested_scenarios = []nested_test_scenario{
	...
	{
		path: "/tiger/123", params: Params{"tiger_id": "123"},
		expected_matches: []string{
			"",
			"/tiger",
			"/tiger/:tiger_id",
	...
	{
		path: "/tiger/123/456", params: Params{"tiger_id": "123", "tiger_cub_id": "456"},
		expected_matches: []string{
			"",
			"/tiger",
			"/tiger/:tiger_id",
	...
	{
		path: "/tiger/123/456/789", params: Params{"tiger_id": "123"}, splat_values: []string{"456", "789"},
		expected_matches: []string{
			"",
			"/tiger",
			"/tiger/:tiger_id",
	...
	{
		path: "/bear/123", params: Params{"bear_id": "123"},
		expected_matches: []string{"", "/bear", "/bear/:bear_id"},
	},
	{
		path: "/bear/123/456", params: Params{"bear_id": "123"}, splat_values: []string{"456"},
		expected_matches: []string{
			"",
			"/bear",
			"/bear/:bear_id",
	...
	{
		path: "/bear/123/456/789", params: Params{"bear_id": "123"}, splat_values: []string{"456", "789"},
		expected_matches: []string{
			"",
			"/bear",
			"/bear/:bear_id",
	...
	{
		path: "/dashboard/customers/123", params: Params{"customer_id": "123"},
		expected_matches: []string{
			"",
			"/dashboard",
			"/dashboard/customers",
	...
	{
		path: "/dashboard/customers/123/orders", params: Params{"customer_id": "123"},
		expected_matches: []string{
			"",
			"/dashboard",
			"/dashboard/customers",
	...
	{
		path: "/dashboard/customers/123/orders/456", params: Params{"customer_id": "123", "order_id": "456"},
		expected_matches: []string{
			"",
			"/dashboard",
			"/dashboard/customers",
...
var nested_opts_to_test = []*Options{
	{},
...
func equal_params(a, b Params) bool {
	if len(a) == 0 && len(b) == 0 {
		return true
	}
...
func opts_uses_explicit_index(opts *Options) bool {
		...
		for _, tc := range nested_scenarios {
			t.Run(tc.path, func(t *testing.T) {
				...
				if fail {
					...
					if !ok && expected_count > 0 {
						errs = append(errs, "Expected matches but got none.")
					}
...
func setup_nested_benchmark() *Matcher {
	m := New(&Options{Quiet: true})
