...
func RawBatchToWorkset(
	...
	for _, evt := range normalized_evts {
		...
		var pre_hook_cmds []strict.Cmd
		var concurrent_hook_cmds []strict.Cmd
		var concurrent_no_wait_hook_cmds []strict.Cmd
		var post_hook_cmds []strict.Cmd
	...
	w.Watcher.WatchNewDirs = created_dirs.ToSlice()
	slices.SortStableFunc(
