				...
				cfg.Watch.Include = []config.ParsedWatchIncludeEntry{
					{
						...
						OnChangeHooks: []config.ParsedOnChangeHook{
							...
							{
								Cmd:    strict.Cmd("conc-a"),
								Timing: config.OnChangeHookTimingConcurrent,
							},
							{
								Cmd:    strict.Cmd("post-a"),
