...
// 	// Core.DevBuildHook
// 	parsed.Core.DevBuildHook = strings.TrimSpace(raw.Core.DevBuildHook)
// 	// Core.ProdBuildHook
// 	parsed.Core.ProdBuildHook = strings.TrimSpace(raw.Core.ProdBuildHook)
// 	// Core.ServerOnlyMode
...
// 			public_path_prefix,
// 		)
// 		parsed.Core.PublicPathPrefix = public_path_prefix
...
// 			parsed.Watch.Include[i].OnChangeHooks[j].Cmd = strings.TrimSpace(
// 				hook.Cmd,
// 			)
