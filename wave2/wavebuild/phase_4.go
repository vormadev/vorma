...
// p4_FWNotificationTaskInput is one backend-convergence fw
// notification execution request.
type p4_FWNotificationTaskInput struct {
	batch        phaseBatchInput
	notification *fwNotificationRequest
}
...
type p4_Output struct {
	...
	requiresBackendRestartWithoutGoCompile bool
	skipFrontendSettling                   bool
}
