...
|---|---|---|---:|---:|---|---|
| `kit/id/README.md` | out-of-scope | n/a | 0 | 0 | pending | Documentation/benchmark artifact. |
| `kit/id/id.go` | in-scope | source+tests | 0 | 0 | pending |  |
| `kit/id/id_test.go` | in-scope | source+tests | 0 | 0 | pending |  |
