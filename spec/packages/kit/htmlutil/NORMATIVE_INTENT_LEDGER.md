# kit/htmlutil Normative Intent Ledger
...
|---|---|---|---:|---:|---|---|
| `kit/htmlutil/README.md` | out-of-scope | n/a | 0 | 0 | pending | Documentation/benchmark artifact. |
| `kit/htmlutil/htmlutil.go` | in-scope | source+tests | 0 | 0 | pending |  |
| `kit/htmlutil/htmlutil_test.go` | in-scope | source+tests | 0 | 0 | pending |  |
