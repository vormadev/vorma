...
|---|---|---|---:|---:|---|---|
| `kit/signedcookie/README.md` | out-of-scope | n/a | 0 | 0 | pending | Documentation/benchmark artifact. |
| `kit/signedcookie/signedcookie.go` | in-scope | source+tests | 0 | 0 | pending |  |
| `kit/signedcookie/signedcookie_test.go` | in-scope | source+tests | 0 | 0 | pending |  |
