# kit/fsutil Normative Intent Ledger
...
|---|---|---|---:|---:|---|---|
| `kit/fsutil/README.md` | out-of-scope | n/a | 0 | 0 | pending | Documentation/benchmark artifact. |
| `kit/fsutil/fsutil.go` | in-scope | source+tests | 0 | 0 | pending |  |
| `kit/fsutil/fsutil_test.go` | in-scope | source+tests | 0 | 0 | pending |  |
