...
- [ ] Record two consecutive no-gap full rounds (`E2-R3`, `E2-R4` observed; item
      remains unchecked until prior open-issue gate is resolved per ordered
      checklist execution).
