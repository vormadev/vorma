# kit/middleware Normative Intent Ledger
...
| ------------------------------ | ------------ | ------------- | -----: | -----------: | ----------- | --------------------------------- |
| `kit/middleware/README.md`     | out-of-scope | n/a           |      0 |            0 | pending     | Documentation/benchmark artifact. |
| `kit/middleware/middleware.go` | in-scope     | source+tests  |      0 |            0 | pending     |                                   |
