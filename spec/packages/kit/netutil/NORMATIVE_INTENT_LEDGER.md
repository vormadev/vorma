# kit/netutil Normative Intent Ledger
...
| ----------------------------- | ------------ | ------------- | -----: | -----------: | ----------- | --------------------------------- |
| `kit/netutil/README.md`       | out-of-scope | n/a           |      0 |            0 | pending     | Documentation/benchmark artifact. |
| `kit/netutil/netutil.go`      | in-scope     | source+tests  |      0 |            0 | pending     |                                   |
| `kit/netutil/netutil_test.go` | in-scope     | source+tests  |      0 |            0 | pending     |                                   |
