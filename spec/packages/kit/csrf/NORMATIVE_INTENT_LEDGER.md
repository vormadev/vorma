# kit/csrf Normative Intent Ledger
...
| ----------------------- | ------------ | ------------- | -----: | -----------: | ----------- | --------------------------------- |
| `kit/csrf/README.md`    | out-of-scope | n/a           |      0 |            0 | pending     | Documentation/benchmark artifact. |
| `kit/csrf/csrf.go`      | in-scope     | source+tests  |      0 |            0 | pending     |                                   |
| `kit/csrf/csrf_test.go` | in-scope     | source+tests  |      0 |            0 | pending     |                                   |
