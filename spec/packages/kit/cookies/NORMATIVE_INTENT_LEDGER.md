# kit/cookies Normative Intent Ledger
...
| ----------------------------- | ------------ | ------------- | -----: | -----------: | ----------- | --------------------------------- |
| `kit/cookies/README.md`       | out-of-scope | n/a           |      0 |            0 | pending     | Documentation/benchmark artifact. |
| `kit/cookies/cookies.go`      | in-scope     | source+tests  |      0 |            0 | pending     |                                   |
| `kit/cookies/cookies_test.go` | in-scope     | source+tests  |      0 |            0 | pending     |                                   |
