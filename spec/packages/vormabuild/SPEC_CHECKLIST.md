...
- [ ] Canonical build/dev requirement catalog is present in this owner package
      path.
...
- [ ] Resolve active implementation-divergence issues in `CONFORMANCE_ISSUES.md`
      (active `VCI-*` backlog).
- [ ] Record two consecutive no-gap full rounds (`E2-R2`, `E2-R3`, `E2-R4`).
