...
- [x] Revalidate imported catalog against source + available legacy tests outside `conformance/**` (when present).
...
- [ ] Resolve active implementation-divergence issues in `CONFORMANCE_ISSUES.md` (active `VCI-*` backlog).
