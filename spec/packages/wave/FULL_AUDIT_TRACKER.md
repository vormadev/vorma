...
| `spec/packages/wave/TRACEABILITY_MATRIX.md`     | in_progress | in_progress | n/a         | 2026-02-09   | Runtime-only rows authored; coverage remains missing.                               |
| `spec/packages/wave/CONFORMANCE_ISSUES.md`      | in_progress | in_progress | n/a         | 2026-02-09   | Runtime intent-validation backlog recorded.                                         |
