...
- [x] `WAVE-*` build/dev owner catalog is canonical in this package path.
- [x] Revalidate build/dev catalog against `wave/tooling/*.go` source +
      available legacy tests outside `conformance/**` (when present).
