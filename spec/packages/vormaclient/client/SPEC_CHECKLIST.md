# vormaclient/client Spec Checklist
...
- [ ] Canonical frontend-runtime requirement catalog is present in this owner
      package path.
...
- [ ] Record two consecutive no-gap full rounds (`E2-R3`, `E2-R4`).
