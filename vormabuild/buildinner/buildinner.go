...
import (
	...
	"github.com/vormadev/vorma/vormabuild/artifactcleanup"
	...
	"github.com/vormadev/vorma/vormabuild/routeartifacts"
...
func defaultBuildInnerDependencies() buildInnerDependencies {
	return buildInnerDependencies{
		...
		cleanStaticPublicOutDir:                   artifactcleanup.CleanStaticPublicOutDir,
