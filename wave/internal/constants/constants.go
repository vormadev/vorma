...
const (
	...
	/////// RUNTIME AND BUILDTIME ENV VARS
	ENV_KEY_IS_DEV       = "WAVE_IS_DEV"
	ENV_KEY_IS_BUILDTIME = "WAVE_IS_BUILDTIME"

	/////// RUNTIME DEV ENV VARS -- injected via dev app supervisor
	ENV_KEY_RUNTIME_DEV_REFRESH_PORT  = "WAVE_DEV_REFRESH_PORT"
	ENV_KEY_RUNTIME_DEV_REFRESH_TOKEN = "WAVE_DEV_REFRESH_TOKEN"
	ENV_KEY_RUNTIME_DEV_STATIC_DIR    = "WAVE_DEV_STATIC_DIR"
	ENV_KEY_RUNTIME_DEV_VITE_PORT     = "WAVE_DEV_VITE_PORT"
