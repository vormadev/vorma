...
func TestPublicURLBuildtime_ReturnsErrorWhenMapIsMissing(t *testing.T) {
	...
	staticProcessor := static.NewProcessor(cfg, newDiscardLoggerForURLFileMapTests())
...
func TestPublicURLBuildtime_ReturnsErrorWhenLookupMisses(t *testing.T) {
	...
	missingURL, found, missingError := staticProcessor.PublicURLBuildtime("images/other.png")
	if missingError != nil {
...
func TestPublicURLBuildtime_ResolvesMappedPath(t *testing.T) {
	...
	mappedURL, found, mappedErr := staticProcessor.PublicURLBuildtime("images/logo.png")
	if mappedErr != nil {
		t.Fatalf(
