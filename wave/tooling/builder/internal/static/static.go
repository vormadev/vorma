...
func writeFrameworkPublicFileMapOutputs(
	...
	typeScriptBuilder.WriteString("/////// Auto-generated by Wave. Do not edit.\n\n")
...
func (processor *Processor) processChangedPaths(
	...
	for _, resolvedRelativePath := range resolvedRelativePaths {
		...
		if resolution.sourceExists {
			...
			shouldCopyFile := true
			if hadOldValueForPath && oldValueForPath.ContentHash == updatedValue.ContentHash {
...
func (processor *Processor) currentPublicFileMap() (wave.FileMap, error) {
	...
	if loadError != nil {
		if !processor.cfg.UsingBrowser() && errors.Is(loadError, os.ErrNotExist) {
