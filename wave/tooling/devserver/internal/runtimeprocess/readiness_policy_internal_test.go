...
func TestNormalizeReadinessWaitPolicy_FillsUnsetFieldsWithDefaults(t *testing.T) {
	...
	if normalizedPolicy.TreatHTTPStatusCodeAsReady(http.StatusInternalServerError) {
