# kit/ioutil Normative Intent Ledger
...
|---|---|---|---:|---:|---|---|
| `kit/ioutil/README.md` | out-of-scope | n/a | 0 | 0 | pending | Documentation/benchmark artifact. |
| `kit/ioutil/ioutil.go` | in-scope | source+tests | 0 | 0 | pending |  |
| `kit/ioutil/ioutil_test.go` | in-scope | source+tests | 0 | 0 | pending |  |
