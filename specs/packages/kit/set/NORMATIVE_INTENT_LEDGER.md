...
|---|---|---|---:|---:|---|---|
| `kit/set/README.md` | out-of-scope | n/a | 0 | 0 | pending | Documentation/benchmark artifact. |
| `kit/set/set.go` | in-scope | source+tests | 0 | 0 | pending |  |
| `kit/set/set_test.go` | in-scope | source+tests | 0 | 0 | pending |  |
