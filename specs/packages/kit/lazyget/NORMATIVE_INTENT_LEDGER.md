...
|---|---|---|---:|---:|---|---|
| `kit/lazyget/README.md` | out-of-scope | n/a | 0 | 0 | pending | Documentation/benchmark artifact. |
| `kit/lazyget/lazyget.go` | in-scope | source+tests | 0 | 0 | pending |  |
| `kit/lazyget/lazyget_test.go` | in-scope | source+tests | 0 | 0 | pending |  |
