...
|---|---|---|---:|---:|---|---|
| `kit/securebytes/README.md` | out-of-scope | n/a | 0 | 0 | pending | Documentation/benchmark artifact. |
| `kit/securebytes/securebytes.go` | in-scope | source+tests | 0 | 0 | pending |  |
| `kit/securebytes/securebytes_test.go` | in-scope | source+tests | 0 | 0 | pending |  |
