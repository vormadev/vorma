...
|---|---|---|---:|---:|---|---|
| `kit/headels/README.md` | out-of-scope | n/a | 0 | 0 | pending | Documentation/benchmark artifact. |
| `kit/headels/headblocks.go` | in-scope | source+tests | 0 | 0 | pending |  |
| `kit/headels/headblocks_test.go` | in-scope | source+tests | 0 | 0 | pending |  |
