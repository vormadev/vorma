...
Applies To: vormaclient/client package runtime behavior as observed via public client APIs, browser APIs, DOM/events, and network I/O
...
- Kit interop map: `specs/packages/vorma/SPEC.md`
- Testing strategy:
  `specs/SPEC_GOVERNANCE.md`
- Roadmap/checklist: `specs/packages/vormaclient/client/SPEC_CHECKLIST.md`
