...
| `vormaclient/client/src/error_boundary.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/events.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/global_loading_indicator/global_loading_indicator.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/hard_reload.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/head_elements/head.advanced_updates.test.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/head_elements/head.basic_operations.test.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/head_elements/head.minimal_dom_changes.test.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/head_elements/head.rest_and_edge_cases.test.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/head_elements/head.test.helpers.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/head_elements/head_elements.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/history/history.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/history/npm_history_types.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/hmr/hmr.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/init_client.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/links.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/redirects/redirects.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/rendering.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/resolve_public_href.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/scroll_state_manager.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/static_route_defs/route_def_helpers.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/ui_lib_impl_helpers/link_components.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/ui_lib_impl_helpers/route_components.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/ui_lib_impl_helpers/typed_navigate.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/utils/errors.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/utils/logging.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/vorma_app_helpers/vorma_app_helpers.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/vorma_ctx/vorma_ctx.test.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/vorma_ctx/vorma_ctx.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/src/window_focus_revalidation/window_focus_revalidation.ts` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
| `vormaclient/client/tsconfig.json` | in-scope | source+legacy-tests | 0 | 0 | pending |  |
