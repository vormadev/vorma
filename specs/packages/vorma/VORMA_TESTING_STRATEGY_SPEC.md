...
- `specs/packages/vorma/VORMA_KIT_INTEROP_SPEC.md` (supporting dependency map)
...
- Backend runtime contracts: `specs/packages/vorma/VORMA_BACKEND_RUNTIME_SPEC.md`
- Wire contracts: `specs/packages/vorma/VORMA_WIRE_CONTRACT_SPEC.md`
- Build/dev contracts: `specs/packages/vorma/VORMA_BUILD_DEV_CONFORMANCE_SPEC.md`
- Frontend contracts: `specs/packages/vorma/VORMA_FRONTEND_RUNTIME_SPEC.md`
- Interop/supporting dependency map: `specs/packages/vorma/VORMA_KIT_INTEROP_SPEC.md`
- Traceability matrix: `specs/packages/vorma/VORMA_TRACEABILITY_MATRIX.md`
- Roadmap checklist: `specs/packages/vorma/VORMA_SPEC_CHECKLIST.md`
