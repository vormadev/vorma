...
canonicalized in `specs/packages/wave/WAVE_BUILD_DEV_CONFORMANCE_SPEC.md`
...
## 4.10 Config Schema Emission Contract
...
## 4.11 Runtime Config Validation Gate Contract
...
## 5.10 Config Schema Emission Scenarios
...
## 5.11 Runtime Config Validation Gate Scenarios
...
- Kit interop boundaries: `specs/packages/vorma/VORMA_KIT_INTEROP_SPEC.md`
- Testing strategy:
  `specs/packages/vorma/VORMA_TESTING_STRATEGY_SPEC.md`
- Overall roadmap: `specs/packages/vorma/VORMA_SPEC_CHECKLIST.md`
