...
- Backend runtime: `specs/packages/vorma/VORMA_BACKEND_RUNTIME_SPEC.md`
- Wire contract: `specs/packages/vorma/VORMA_WIRE_CONTRACT_SPEC.md`
- Build/dev: `specs/packages/vorma/VORMA_BUILD_DEV_CONFORMANCE_SPEC.md`
- Frontend runtime: `specs/packages/vorma/VORMA_FRONTEND_RUNTIME_SPEC.md`
