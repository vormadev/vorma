...
- Frontend runtime contracts: `specs/packages/vorma/VORMA_FRONTEND_RUNTIME_SPEC.md`
- Observability contracts: `specs/packages/vorma/VORMA_OBSERVABILITY_DEBUG_SPEC.md`
- Testing strategy: `specs/packages/vorma/VORMA_TESTING_STRATEGY_SPEC.md`
