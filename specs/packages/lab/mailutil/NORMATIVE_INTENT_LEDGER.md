# lab/mailutil Normative Intent Ledger
...
|---|---|---|---:|---:|---|---|
| `lab/mailutil/mailutil.go` | in-scope | source+tests | 0 | 0 | pending |  |
| `lab/mailutil/mailutil_test.go` | in-scope | source+tests | 0 | 0 | pending |  |
