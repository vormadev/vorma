# Wave Conformance Issues Backlog

Status: Draft  
Last Updated: 2026-02-09  
Purpose: Track Wave-owned implementation divergences for build/dev control-plane contracts.

## Delegation Rule

This file is authoritative for Wave-owned issues.

Legacy cross-package VCI references are intentionally omitted here to avoid
stale dependency on non-Wave issue numbering.

## Open Wave-Owned Issues

| WCI ID | Affected Wave Requirement(s) | Summary | Status |
|---|---|---|---|
