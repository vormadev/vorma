...
Framework specs (including Vorma) SHOULD reference these requirement IDs
instead of duplicating `wave/tooling` internals.
...
- Wave runtime-serving owner contracts: `specs/packages/wave/SPEC.md`
- Wave runtime traceability: `specs/packages/wave/TRACEABILITY_MATRIX.md`
- Wave runtime conformance issues: `specs/packages/wave/CONFORMANCE_ISSUES.md`
