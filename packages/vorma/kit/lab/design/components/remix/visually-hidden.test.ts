...
function create_test_visually_hidden(): ReturnType<typeof createVisuallyHidden> {
...
describe("Remix VisuallyHidden", () => {
	...
	it("renders accessible content in a visually hidden host", () => {
		...
		expect(host?.getAttribute(componentAnatomyAttrs.scope)).toBe(visuallyHiddenScope);
