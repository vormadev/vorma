...
// CopyFileAtomically copies source content into destination using one atomic
// temp-write-and-rename operation.
...
func (executor atomicFileWriteExecutor) writeFileAtomically(
	...
	if mkdirErr := os.MkdirAll(targetDirectoryPath, 0o755); mkdirErr != nil {
