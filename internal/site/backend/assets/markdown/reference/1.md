...
| `ClientRouteDefinitionPatterns` | **Yes**  | Frontend route definition file patterns (supports modular files).             |
...
Create `backend/src/router/app.go`:
...
func main() {
    vormabuild.Build(router.GetApp())
}
```
