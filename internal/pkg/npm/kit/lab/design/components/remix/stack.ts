...
export type StackRecipeGap<TRecipe extends StackRecipeInput> =
	RecipeVariantValue<TRecipe, "gap">;

export type StackRecipeLayout<TRecipe extends StackRecipeInput> =
