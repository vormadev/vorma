...
export type TextRecipeVariant<TRecipe extends TextRecipeInput> =
	RecipeVariantValue<TRecipe, "variant">;

export type TextRecipeTone<TRecipe extends TextRecipeInput> =
	RecipeVariantValue<TRecipe, "tone">;

export type TextRecipeSelection<TRecipe extends TextRecipeInput> =
