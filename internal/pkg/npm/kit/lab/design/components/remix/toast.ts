...
export type ToastRecipeTone<TRecipe extends ToastRecipeInput> =
	RecipeVariantValue<TRecipe, "tone">;

export type ToastRecipeVariant<TRecipe extends ToastRecipeInput> =
...
>(
	...
	function Root(
		...
		return (
			props: ToastRootProps<TTone, TVariant, TBreakpoint>,
		): RemixNode => {
			const {
				at,
				children,
