...
export type StatRecipeInput<TValueTone extends string = string> =
...
export type StatRecipeValueTone<TRecipe extends StatRecipeInput> =
	RecipeVariantValue<TRecipe, "valueTone">;
export type StatRecipeSelection<TRecipe extends StatRecipeInput> =
	RecipeVariantPropsFor<TRecipe, "valueTone">;
