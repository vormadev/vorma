...
export type SurfaceRecipeVariant<TRecipe extends SurfaceRecipeInput> =
	RecipeVariantValue<TRecipe, "variant">;

export type SurfaceRecipeDensity<TRecipe extends SurfaceRecipeInput> =
	RecipeVariantValue<TRecipe, "density">;

export type SurfaceRecipeLayout<TRecipe extends SurfaceRecipeInput> =
