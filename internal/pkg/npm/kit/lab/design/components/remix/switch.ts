...
export type SwitchRecipeCondition =
...
export type SwitchRecipeVariant<TRecipe extends SwitchRecipeInput> =
	RecipeVariantValue<TRecipe, "variant">;

export type SwitchRecipeSize<TRecipe extends SwitchRecipeInput> =
...
> = Omit<
	Props<"input">,
	"checked" | "defaultChecked" | "role" | "style" | "type"
> &
