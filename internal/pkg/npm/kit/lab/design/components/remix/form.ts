...
export type FormRecipeInput<TLayout extends string = string> =
...
export type FormRecipeLayout<TRecipe extends FormRecipeInput> =
	RecipeVariantValue<TRecipe, "layout">;

export type FormRecipeSelection<TRecipe extends FormRecipeInput> =
