...
export type ChipRecipeVariant<TRecipe extends ChipRecipeInput> =
	RecipeVariantValue<TRecipe, "variant">;

export type ChipRecipeSize<TRecipe extends ChipRecipeInput> =
	RecipeVariantValue<TRecipe, "size">;

export type ChipRecipeSelection<TRecipe extends ChipRecipeInput> =
	RecipeVariantPropsFor<TRecipe, "selected" | "size" | "variant">;
