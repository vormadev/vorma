...
export type TableRecipeDensity<TRecipe extends TableRecipeInput> =
	RecipeVariantValue<TRecipe, "density">;
export type TableRecipeLayout<TRecipe extends TableRecipeInput> =
	RecipeVariantValue<TRecipe, "layout">;
export type TableRecipeRowVariant<TRecipe extends TableRecipeInput> =
	RecipeVariantValue<TRecipe, "rowVariant">;
export type TableRecipeCellVariant<TRecipe extends TableRecipeInput> =
	RecipeVariantValue<TRecipe, "cellVariant">;
...
> {
	...
	return () => {
		return (
			props: TableProps<TDensity, TLayout, TBreakpoint>,
		): RemixNode => {
			const { at, children, density, layout, mix, ...table_props } =
				props;
...
>(
	...
	return () => {
		return (
			props: TableRowProps<TableRecipeRowVariant<TRecipe>>,
		): RemixNode => {
...
>(
	...
	return () => {
		return (
			props: TableCellProps<TableRecipeCellVariant<TRecipe>>,
		): RemixNode => {
