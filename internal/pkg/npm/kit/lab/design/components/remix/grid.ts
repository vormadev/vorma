...
export type GridRecipeColumns<TRecipe extends GridRecipeInput> =
	RecipeVariantValue<TRecipe, "columns">;
...
export type GridRecipeLayout<TRecipe extends GridRecipeInput> =
	RecipeVariantValue<TRecipe, "layout">;

export type GridRecipeSelection<TRecipe extends GridRecipeInput> =
	RecipeVariantPropsFor<TRecipe, "columns" | "gap" | "layout">;
